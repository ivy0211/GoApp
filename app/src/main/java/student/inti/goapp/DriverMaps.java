...
public class DriverMaps extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DriverMaps.this, Settings.class);
    ...
    public void LogOutUser() {
        Intent intent = new Intent(DriverMaps.this, Welcome.class);
